...
export default class BroadcastOpen extends BaseCommand<typeof BroadcastOpen> {
  static summary = "Open a broadcast in the Knock dashboard.";
  ...
  async run(): Promise<void> {
    ...
    this.log(
      `‣ Opening broadcast \`${broadcastKey}\` in the Knock dashboard...`,
    );
    this.log(`  ${url}`);
